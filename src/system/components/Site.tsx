...
import PageShowcaseRedux from './PageShowcaseRedux';// ::showcaseRedux
...
<li><Link to='/showcaseRedux'>Showcase Redux</Link></li>{/* ::showcaseRedux */}
							</>
						)}
					</ul>
				</nav>
...
<Route path='/showcaseRedux'><PageShowcaseRedux /></Route>{/* ::showcaseRedux */}
					</Switch>
				</section>
			</div>
		</Router>
