...
import PageCreatePage2 from './PageCreatePage2';// ::createPage2
...
<span><Link to='/createPage2'>Create Page2</Link></span>{/* ::createPage2 */}
						</>
					)}
				</nav>
...
<Route path='/createPage2'><PageCreatePage2 /></Route>{/* ::createPage2 */}
					</Switch>
				</section>
			</div>
		</Router>
